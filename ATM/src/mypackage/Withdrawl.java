...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    Withdrawl(String pin){
        ...
        l2.setBounds(215,200,400,20);
        l3.add(l2);
        
        t1.setBounds(190,240,290,30);
        l3.add(t1);
        
        b1.setBounds(260,290,150,35);
        l3.add(b1);
        
        b2.setBounds(260,340,150,35);
        l3.add(b2);
    ...
    public void actionPerformed (ActionEvent ae) {
    	if (ae.getSource() == b1) {
    		...
    		if(t1.getText().equals("")) {
    			...
    			try {
    				Conn c1 = new Conn();
    				String q ="insert into bank values('"+pin+"', '"+date+"', 'Withdrawl', '"+amount+"')";
